...
//
//import com.cloud.apigateway.filter.Oauth2ClientFilter;
...
////        http.authorizeRequests().antMatchers("/oauth-api/**", "/login").permitAll().anyRequest().authenticated()
////                .and()
...
//            private final AntPathRequestMatcher[] requestMatchers = { new AntPathRequestMatcher("/oauth-api/**") };
//
//            @Override
